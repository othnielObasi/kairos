...
│   │   └── ace-engine.ts              # + Nanopayment per SAGE reflection
│   ├── trust/
...
npm install
npm install @circle-fin/developer-controlled-wallets @circle-fin/nanopayments @x402/fetch @x402/evm viem
```
...
*NOVTIA Ltd · Kairos · Agentic Economy on Arc · 2026*
