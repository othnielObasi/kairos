...
assert(artifact.strategy.signalConfidence >= 0 && artifact.strategy.signalConfidence <= 1, `Confidence in range: ${artifact.strategy.signalConfidence}`);
...
//# sourceMappingURL=test-artifacts.js.map
