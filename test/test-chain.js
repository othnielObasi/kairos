...
console.log('\n── EIP-191 Signing ──');
const authMessage = ethers.solidityPacked(['address', 'uint256', 'uint256', 'uint256'], [testWallet.address, 12345, 100, Math.floor(Date.now() / 1000) + 86400]);
...
//# sourceMappingURL=test-chain.js.map
